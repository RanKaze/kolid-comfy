...
export function Lora({ lora, initialActiveTags, initialStrength, initialActive, initialSplitMode, onChange, onRemove }: LoraProps) {
  ...
  return (
    <div className={`lora-card ${cardActive ? 'active' : ''}`} onMouseDown={toggleCard}>
