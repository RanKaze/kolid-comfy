...
export function useTempContext() {
  ...
  const toggleId = useCallback((id: string) => {
    setStack(prev => {
      ...
      if (last.type !== 'lora' && last.type !== 'prefab' && last.type !== 'program' && last.type !== 'prefabCtx' && last.type !== 'loraCtx' && last.type !== 'promptCtx' && last.type !== 'prefabBuiltin' && last.type !== 'loraBuiltin' && last.type !== 'promptBuiltin') return prev;
