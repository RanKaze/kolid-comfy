...
const StringSwitchCard: React.FC<Props> = ({ name, value, selected, onClick }) => {
  return (
    <button
      style={{
        ...cardStyle,
        borderColor: selected ? 'rgba(175, 82, 222, 0.6)' : 'rgba(255,255,255,0.12)',
        boxShadow: selected
          ? '0 0 0 3px rgba(175, 82, 222, 0.3), 0 8px 32px rgba(0,0,0,0.4)'
      ...
      onMouseEnter={(e) => {
        ...
        (e.currentTarget as HTMLButtonElement).style.boxShadow = selected
          ? '0 0 0 3px rgba(175, 82, 222, 0.3), 0 12px 40px rgba(0,0,0,0.5)'
